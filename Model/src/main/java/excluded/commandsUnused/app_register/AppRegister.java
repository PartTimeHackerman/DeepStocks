...
public class AppRegister implements Serializable
{
    ...
    private final static long serialVersionUID = 8948814131300972353L;
     ...
     */
    public AppRegister(String name, Integer appId, String redirectUri, String homepage, String github, String appstore, String googleplay, Double appMarkupPercentage) {
        super();
        this.name = name;
        this.appId = appId;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AppRegister) == false) {
            return false;
        }
        AppRegister rhs = ((AppRegister) other);
