...
public class TicksHistorySend implements Serializable, BinaryMessage
{
    ...
    private final static long serialVersionUID = -1949828838796239505L;
    ...
    public enum Style {
        ...
        private final static Map<String, TicksHistorySend.Style> CONSTANTS = new HashMap<String, TicksHistorySend.Style>();
