...
public class GsonSerializer {
	...
	public static List<StockData> loadStocksData() {
		return loadJsons("stocks/", StockData.class);
	}
	
	public static void saveStocksData(List<StockData> stocksData) {
		for (StockData data : stocksData) {
