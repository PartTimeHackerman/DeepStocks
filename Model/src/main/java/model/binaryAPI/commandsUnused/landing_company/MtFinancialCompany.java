 ...
 * 
 */
public class MtFinancialCompany implements Serializable
{
    ...
    private final static long serialVersionUID = 608795330381299868L;

    /**
     * No args constructor for use in serialization
     * 
     */
    public MtFinancialCompany() {
    }
     ...
     */
    public MtFinancialCompany(String shortcode, String name, List<String> address, String country, String legalDefaultCurrency, List<String> legalAllowedCurrencies, List<String> legalAllowedMarkets, List<String> legalAllowedContractCategories, Integer hasRealityCheck) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MtFinancialCompany) == false) {
            return false;
        }
        MtFinancialCompany rhs = ((MtFinancialCompany) other);
