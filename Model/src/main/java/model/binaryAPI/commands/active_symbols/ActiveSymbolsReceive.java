...
public class ActiveSymbolsReceive implements Serializable, BinaryMessage {
	...
	private static final long serialVersionUID = 6076610137904776706L;
	/**
	 * Echo request
	 * <p>
	...
	@Expose
	private List<BinaryData> activeSymbols = new ArrayList<BinaryData>();
	/**
	 * active_symbols
	 * (Required)
	 */
	 ...
	 * @param reqId
	 */
	public ActiveSymbolsReceive(Object echoReq, List<BinaryData> activeSymbols, String msgType, Integer reqId) {
		super();
	 ...
	 * List of active symbols. Note: if the user is authenticated, then only symbols allowed under his account will be returned.
	 */
	public List<BinaryData> getActiveSymbols() {
	 ...
	 * List of active symbols. Note: if the user is authenticated, then only symbols allowed under his account will be returned.
	 */
	public void setActiveSymbols(List<BinaryData> activeSymbols) {
		this.activeSymbols = activeSymbols;
	}
