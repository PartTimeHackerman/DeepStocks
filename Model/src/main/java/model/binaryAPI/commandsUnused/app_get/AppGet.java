 ...
 * 
 */
public class AppGet implements Serializable
{
    ...
    private final static long serialVersionUID = 107675826063962321L;
     ...
     */
    public AppGet(String name, Integer appId, String redirectUri, String homepage, String github, String appstore, String googleplay, Double appMarkupPercentage) {
        super();
        this.name = name;
        this.appId = appId;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AppGet) == false) {
            return false;
        }
        AppGet rhs = ((AppGet) other);
