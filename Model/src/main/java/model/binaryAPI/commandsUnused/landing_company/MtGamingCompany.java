 ...
 * 
 */
public class MtGamingCompany implements Serializable
{
    ...
    private final static long serialVersionUID = 7409258227063297663L;

    /**
     * No args constructor for use in serialization
     * 
     */
    public MtGamingCompany() {
    }
     ...
     */
    public MtGamingCompany(String shortcode, String name, List<String> address, String country, String legalDefaultCurrency, List<String> legalAllowedCurrencies, List<String> legalAllowedMarkets, List<String> legalAllowedContractCategories) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MtGamingCompany) == false) {
            return false;
        }
        MtGamingCompany rhs = ((MtGamingCompany) other);
